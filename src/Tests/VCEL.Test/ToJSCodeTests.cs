...
namespace VCEL.Test
{
    public class ToJsCodeTests
    {
        ...
        [TestCase("t == 'C'", "((vcelContext.t === null ? null : vcelContext.t.valueOf()) === 'C')")]
        [TestCase("t == s", "((vcelContext.t === null ? null : vcelContext.t.valueOf()) === (vcelContext.s === null ? null : vcelContext.s.valueOf()))")]
        [TestCase("t != s", "((vcelContext.t === null ? null : vcelContext.t.valueOf()) !== (vcelContext.s === null ? null : vcelContext.s.valueOf()))")]
        ...
        [TestCase("(K == 'C' or K == 'AC')", "(((vcelContext.K === null ? null : vcelContext.K.valueOf()) === 'C') || ((vcelContext.K === null ? null : vcelContext.K.valueOf()) === 'AC'))")]

        [TestCase("(a < t and a > 0)", "((vcelContext.a < vcelContext.t) && (vcelContext.a > 0))")]
        [TestCase("s == null", "((vcelContext.s === null ? null : vcelContext.s.valueOf()) === null)")]
        [TestCase("s != null", "((vcelContext.s === null ? null : vcelContext.s.valueOf()) !== null)")]
        [TestCase("s != null and s == 'ACTIVE'", "(((vcelContext.s === null ? null : vcelContext.s.valueOf()) !== null) && ((vcelContext.s === null ? null : vcelContext.s.valueOf()) === 'ACTIVE'))")]
        ...
        [TestCase("a / b", "(vcelContext.a / vcelContext.b)")]
        [TestCase("a * b", "(vcelContext.a * vcelContext.b)")]
        [TestCase("a == b", "((vcelContext.a === null ? null : vcelContext.a.valueOf()) === (vcelContext.b === null ? null : vcelContext.b.valueOf()))")]
        [TestCase("a != b", "((vcelContext.a === null ? null : vcelContext.a.valueOf()) !== (vcelContext.b === null ? null : vcelContext.b.valueOf()))")]
